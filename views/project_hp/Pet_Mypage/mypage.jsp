...
<body>
	...
	<div class="mypageBack">
		...
		<c:choose>
			<c:when  test="${loginUser.usertype eq 'oper' }">
			<form id="updateForm" action="./member_info_update"
			...
			<form id="updateForm" action="./member_info_update"
				...
				<div class="input">
					...
					<ul class="input-block">
						...
						<li><input type="hidden" class="textblock" name="hospital_name"
							value="${mVo.hospital_name }" /></li>
					</ul>
					<ul class="input-block">
						
						<li><input type="hidden" class="textblock" name="hospital_num"
							value="${mVo.hospital_num }" /></li>
					</ul>
					<ul class="input-block">
						
						<li><input type="hidden" class="textblock" name="hospital_li"
							value="${mVo.hospital_li}" /></li>
					</ul>
					<ul class="input-block">
