...
public interface PetDao {
	...
	public ArrayList<VetClinicBoardVO> vetselectAllBoards(String page, String pageDataCount);
	//comment
	...
	public ArrayList<VetClinicBoardVO> vetboardlist(String page, String pageDataCount);
}
